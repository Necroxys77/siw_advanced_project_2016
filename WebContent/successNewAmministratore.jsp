...
<body>
	...
	<div class="container">
		...
		<f:view>
			<h1>Inserimento nuovo Amministratore effettuato con successo!</h1>
			<br>
			<hr>
			<br>
			<h2>Dettagli</h2>
