...
<title>Riepilogo Paziente</title>
...
<body>
	...
	<div class="container">
		...
		<f:view>
			...
			<h1>Impossibile inserire il nuovo Paziente.</h1>
			<br>
			...
			<br>
			<div>
				<a href='<c:url value="/faces/newPaziente.jsp" />'>Torna
					ad inserire il nuovo <i>Paziente</i>
				</a>.
			</div>
		</f:view>
