		...
		<div class="container">
			...
			<div class="navbar-collapse collapse" aria-expanded="false"
				...
				<ul class="nav navbar-nav">
					<li class="active"><a href="admin.jsp">Hello ${amministratoreController.amministratore.email}</a></li>
				</ul>
			</div>
			<!--/.nav-collapse -->
		</div>
	...
	<div class="container">
		...
		<f:view>
			...
			<table class="table">
				...
				<tbody>
					<tr class="success">
						<td>${tipologiaEsameController.tipologiaEsame.id}</td>
						<td>${tipologiaEsameController.tipologiaEsame.nome}</td>
